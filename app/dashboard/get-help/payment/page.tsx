...
import MetodePembayaran from "./_components/MetodePembayaran";
import MasalahPembayaran from "./_components/MasalahPembayaran";
import PengembalianDana from "./_components/PengembalianDana";
import InvoiceTagihan from "./_components/InvoiceTagihan";

export default function SupportPagePaymentntUser() {
  ...
  const navItems = [
    ...
    { href: "#masalah-pembayaran", label: "Masalah Pembayaran" },
    { href: "#pengembalian-dana", label: "Pengembalian Dana (Refunds)" },
    { href: "#invoice-tagihan", label: "Invoice & Tagihan" },
  ];
        ...
        <div className="flex flex-col h-full">
          <div className="top-0 bg-transparent border-b border-slate-200 p-4 flex items-center justify-between">
            <h2 className="text-lg font-semibold text-blue-600">
              Panduan Pembayaran & Pengembalian Dana
            </h2>
            <Button
              variant="ghost"
              size="icon"
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-x-hidden overflow-y-auto bg-transparent p-6 md:p-10">
          ...
          <p className="text-lg text-gray-600 dark:text-white mb-8">
            Informasi seputar metode pembayaran, tagihan, dan kebijakan
            pengembalian dana di Selearn.
          </p>
