...
const SliderCourse = ({ items = data }: Gallery4Props) => {
  ...
  return (
    <section>
      <div className="container mx-auto">
        <div className="mb-8 flex items-center justify-center md:mb-2 lg:mb-4">
                ...
                <a href={item.href} className="group rounded-xl">
                  <div className="group relative h-full min-h-[27rem] max-w-full overflow-hidden rounded-xl md:aspect-[5/4] lg:aspect-[16/9]">
                    <img
                      src={item.image}
                      alt={item.title}
                      className="absolute h-full w-full object-cover object-center transition-transform duration-300 group-hover:scale-105 brightness-60"
                    />
                    <div className="absolute inset-0 h-full bg-[linear-gradient(hsl(var(--primary)/0),hsl(var(--primary)/0.4),hsl(var(--primary)/0.8)_100%)] mix-blend-multiply" />
                    <div className="absolute inset-x-0 bottom-0 flex flex-col items-start p-6 text-primary-foreground md:p-8">
                      <Badge className="text-sm text-white rounded-lg">
                        {item.badge}
                      </Badge>
                      ...
                      <div className="flex items-center text-sm hover:bg-primary hover:text-white p-2 rounded-lg">
                        Let&apos;s go{" "}
