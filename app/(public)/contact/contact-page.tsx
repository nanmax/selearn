...
import { Button, ButtonProps } from "./_components/button-contact";

const APP_EMAIL = "dev.wheelbox@gmail.com";
const APP_PHONE = "+62 851 - 8972 - 2630";
const APP_PHONE_2 = "+62 895 - 3351 - 81400";

export function ContactPage() {
  const socialLinks = [
    {
      icon: TwitterIcon,
      href: "https://twitter.com/selearnid",
      label: "Twitter",
    },
    {
      icon: LinkedinIcon,
      href: "https://linkedin.com/company/selearn",
      label: "LinkedIn",
    },
    {
      icon: InstagramIcon,
      href: "https://instagram.com/selearn.id",
      label: "Instagram",
    },
    {
      icon: FacebookIcon,
      href: "https://facebook.com/selearn.id",
      label: "Facebook",
    },
  ];
        ...
        <div className="grid md:grid-cols-3">
          ...
          <Box
            ...
            <span className="font-mono text-base font-medium tracking-wide">
              Jalan Siliwangi No. 45, Cianjur, Jawa Barat, 43212, Indonesia
            </span>
          </Box>
          <Box
            icon={Phone}
            ...
            <div>
              <div className="flex items-center gap-x-2">
                ...
                <CopyButton className="size-6" test="+6285723217867" />
              </div>
              <div className="flex items-center gap-x-2">
                <a
                ...
                <CopyButton className="size-6" test="+6289533518140" />
              </div>
            </div>
          </Box>
        </div>
