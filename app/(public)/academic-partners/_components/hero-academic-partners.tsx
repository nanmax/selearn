    ...
    <section className="relative bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-20 md:py-28 overflow-hidden">
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        <motion.p
          ...
          Bermitra dengan Selearn untuk membekali mahasiswa Anda dengan
          keterampilan praktis yang paling dicari, memastikan mereka siap
...
export default HeroAcademicPartners;
