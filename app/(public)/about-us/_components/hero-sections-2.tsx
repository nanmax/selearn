...
import { motion, easeOut, circOut } from "framer-motion";
...
interface HeroSectionProps extends React.ComponentProps<typeof motion.section> {
  logo?: {
    url: string;
    alt: string;
    text?: string;
...
const HeroSection = React.forwardRef<HTMLDivElement, HeroSectionProps>(
  ({ className, logo, slogan, heading, subtitle, callToAction, backgroundImage, contactInfo, ...props }, ref) => {
                ...
                <motion.header className="mb-12" variants={itemVariants}>
                    {logo && (
                        <div className="flex items-center">
                            ...
                            <div>
                                {logo.text && <p className="text-lg font-bold text-primary">{logo.text}</p>}
