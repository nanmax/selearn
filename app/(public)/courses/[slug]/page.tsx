...
export default async function SlugPage({ params }: { params: Params }) {
  ...
  return (
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 mt-5 p-10">
      <div className="order-1 lg:col-span-2">
        ...
        <div className="mt-12 space-y-12">
          ...
          <div className="space-y-4">
            {course.chapter.map((chapter: Chapter, index: number) => (
                        ...
                        {chapter.lessons.map((lesson, lessonIndex) => (
                          <div
                            ...
                            <div className="flex size-8 items-center justify-center rounded-full bg-background border-2 border-primary/20">
                              <IconPlayerPlay className="size-4 text-muted-foreground group-hover:text-primary transition-all" />
                            </div>
              ...
              <div className="mb-6 space-y-2 rounded-lg bg-muted p-4">
                ...
                <div className="flex flex-col gap-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium">Difficult Level</p>
                      <p className="text-sm text-muted-foreground">
                        {course.level}
                      </p>
                    </div>
              ...
              <div className="mb-6 space-y-2">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-center gap-2 text-sm">
                    ...
                    <span>Access on mobile and dekstop</span>
                  </li>
                  <li className="flex items-center gap-2 text-sm">
                    <div className="rounded-full p-1 bg-green-500/10 text-green-500">
                      <CheckIcon className="size-3" />
